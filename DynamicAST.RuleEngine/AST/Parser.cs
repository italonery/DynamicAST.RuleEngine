...
/// <summary>
/// A recursive descent parser that constructs an Abstract Syntax Tree (AST) from a sequence of tokens.
/// </summary>
/// <remarks>
/// The parser enforces mathematical and logical operator precedence: 
/// Parentheses and Primary types > Comparison Operators > Logical AND > Logical OR.
/// </remarks>
public class Parser
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="Parser"/> with the provided tokens.
    /// </summary>
    /// <param name="tokens">The sequential list of tokens generated by the <see cref="Lexer"/>.</param>
    ...
    /// <summary>
    /// Parses the token sequence and builds the root node of the Abstract Syntax Tree.
    /// </summary>
    /// <returns>The root <see cref="ExpressionNode"/> of the evaluated tree.</returns>
    /// <exception cref="Exception">Thrown when a syntax error is encountered, such as mismatched parentheses or invalid operators.</exception>
